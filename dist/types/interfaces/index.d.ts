...
export interface onMessageAsyncInterface {
    ...
    validateSender?: (sender: browser.runtime.MessageSender) => boolean;
    onAsyncCb?: (message: unknown, sender: browser.runtime.MessageSender) => Promise<any>;
}
...
export interface handlerInterface {
    (message: unknown, sender: browser.runtime.MessageSender, sendResponse?: (payload: StandardResponse) => void): boolean;
}
